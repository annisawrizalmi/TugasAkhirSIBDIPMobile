...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView NIP,
      @NonNull CircleImageView avatar, @NonNull TextView userName) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.NIP;
      TextView NIP = ViewBindings.findChildViewById(rootView, id);
      if (NIP == null) {
        break missingId;
      }
      ...
      return new NavHeaderBinding((LinearLayout) rootView, NIP, avatar, userName);
    }
